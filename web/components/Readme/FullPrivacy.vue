...
<template>
    <main class="flex flex-col gap-5">
        ...
        <NuxtLink to="https://z.cash/zcashs-privacy-is-normal-goes-viral/" target="_blank" class="pl-5 flex flex-row gap-2 items-baseline text-xl text-blue-500 font-bold hover:underline">
            Because <span class="text-2xl">Censorship is REAL!</span>
    ...
    <p>
        ...
        <p>
            The #1 benefit of a non-TOTAL approach is that <NuxtLink to="https://nexa.wiki/supernet" target="_blank" class="text-blue-500 font-bold hover:underline">Supernet</NuxtLink> assets CANNOT be banned by Centralized Exchanges (CEXs);
            as it would require banning the Host asset as well.
            100% of <NuxtLink to="https://nexa.wiki/supernet" target="_blank" class="text-blue-500 font-bold hover:underline">Supernet</NuxtLink> assets are available for trading on Decentralized Exchanges (DEXs).
        </p>
    </main>
</template>
